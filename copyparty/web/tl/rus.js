...
Ls.rus = {
	...
	"hks": [
		[
			...
			["S", "выделить файл"],
			["Y", "скачать текстовый файл"],
			["⇧ J", "форматировать json для чтения"],
		]
	],
	...
	"ot_md": "new-file: создать новый текстовый файл",
	...
	"ab_mkdoc": "создать текстовый файл",
	...
	"ut_ow": "перезаписывать существующие файлы на сервере?$N🛡️: нет (для повторяющихся файлов будут создаваться новые имена)$N🕒: перезаписать файлы с датой изменения старее, чем у загружаемых$N♻️: всегда перезаписывать (если файлы различаются по содержанию)$N⏭️: безусловно пропускать все существующие файлы",
	...
	"cl_bigdir": "бол. папки",
	"cl_hsort": "#сорт.",
	"cl_keytype": "музыкальная нотация",
	...
	"ct_dsel": 'выделять файлы перетаскиванием в режиме сетки">выделение',
	"ct_dl": 'скачивать файл при клике вместо предпросмотра">dl',
	...
	"ct_utc": 'показывать все даты в UTC">UTC',
	...
	"tt_gauto": "показывать сетку или список в зависимости от содержимого папки",
	"tt_gathr": "использовать сетку, если этот процент файлов — изображения/видео",
	...
	"mt_mnext": "загрузить следующую папку и продолжить в ней",
	...
	"mt_c2flac": "лучшее качество звука, но большие файлы\">flac",
	"mt_c2wav": "несжатое воспроизведение (файлы ещё больше)\">wav",
	...
	"mt_ss": "`включает пропуск тишины; умножает скорость на `уск` возле начала/конца, когда громкость ниже `гром` и позиция в первых `нач`% или последних `кон`%",
	"mt_ssvt": "порог громкости (0-255)\">гром",
	"mt_ssts": "активный порог (% трека, начало)\">нач",
	"mt_sste": "активный порог (% трека, конец)\">кон",
	"mt_sssm": "множитель ускорения\">уск",
	...
	"mm_e415": "Не удалось воспроизвести аудио; ошибка 415: Сбой транскодирования файла; проверьте логи сервера.",
	...
	"f_dl_nd": 'пропуск папки (для папок используйте загрузку в виде архива):\n',
	...
	"fp_ename": "{0} файлов невозможно перенести сюда, потому что их имена уже заняты. Введите имена ниже, чтобы продолжить, или оставьте поля пустыми (\"пропустить конфликты\"), чтобы пропустить:",
	"fcp_ename": "{0} файлов невозможно скопировать сюда, потому что их имена уже заняты. Введите имена ниже, чтобы продолжить, или оставьте поля пустыми (\"пропустить конфликты\"), чтобы пропустить:",
	...
	"mk_noname": "сначала введите имя в текстовое поле слева :p",
	"nmd_i1": "вы также можете указать нужное расширение, например <code>.md</code>",
	"nmd_i2": "вы можете создавать только файлы <code>.{0}</code>, так как у вас нет разрешения на удаление",
	...
	"tvt_j": "форматировать json для чтения$NГорячая клавиша: shift-J\">j",
	...
	"b2old": 'ваш браузер слишком старый', //m
	...
	"rc_opn": "открыть",
	"rc_ply": "воспроизвести",
	"rc_pla": "воспроизвести как аудио",
	"rc_txt": "открыть в просмотрщике файлов",
	"rc_md": "открыть в текстовом редакторе",
	"rc_wopi": "открыть в офисном редакторе",
	"rc_dl": "скачать",
	"rc_zip": "скачать как архив",
	"rc_cpl": "копировать ссылку",
	"rc_del": "удалить",
	"rc_cut": "вырезать",
	"rc_cpy": "копировать",
	"rc_pst": "вставить",
	"rc_rnm": "переименовать",
	"rc_nfo": "новая папка",
	"rc_nfi": "новый файл",
	"rc_sal": "выбрать всё",
	"rc_sin": "инвертировать выделение",
	"rc_shf": "поделиться этой папкой",
	"rc_shs": "поделиться выделенным",
	...
	"splash": {
		...
		"ls3": "войти",
		"lu4": "имя пользователя",
		"lp4": "пароль",
		"lo3": "выйти из аккаунта “{0}” везде",
		"lo2": "это завершит сеанс во всех браузерах",
		"m1": "с возвращением,",
		"n1": "404 не найдено &nbsp;┐( ´ -`)┌",
		...
		"nop": "ОШИБКА: Пароль не может быть пустым",
		"nou": "ОШИБКА: Имя пользователя и/или пароль не могут быть пустыми",
		"aa1": "входящие файлы:",
		"ab1": "отключить no304",
		"ac1": "включить no304",
