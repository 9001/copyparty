...
var Ls = {
	...
	"epo": {
		...
		"mt_eq": "ŝaltas ekvalizilon kaj stirilon de plifortigado;$N$Nforto &lt;code&gt;0&lt;/code&gt; = senmodifa 100%a laŭteco$N$Nlarĝo &lt;code&gt;1 &nbsp;&lt;/code&gt; = senmodifa dukanala sono$Nlarĝo &lt;code&gt;0.5&lt;/code&gt; = 50% miksado inter maldekstra kaj dekstra kanaloj$Nlarĝo &lt;code&gt;0 &nbsp;&lt;/code&gt; = unukanala sono$N$Nforto &lt;code&gt;-0.8&lt;/code&gt; &amp; larĝo &lt;code&gt;10&lt;/code&gt; = senvokigo :^)$N$Nŝaltita ekvalizilo ankaŭ forigas paŭzojn inter muzikaĵoj en senpaŭzaj albumoj, agordi ĉion kiel 0 (sed larĝo kiel 1), se vi volas nur tion",
		"mt_drc": "ŝaltas kompresoron de dinamiko (glatigas laŭtecon de muzikaĵoj); ankaŭ ŝaltas ekvalizilon, do agordu ĉion (sed larĝo) kiel 0, se vi ne volas ĝin; $N$Nplimalgrandigas laŭtecon de aŭdio super sojlo-valoro da dB; ĉiu proporcio-valoro da dB post sojlo 1 dB estos eligita, do implicitaj valoroj (sojlo = -24, proporcio = 12) faras, ke laŭteco neniam pli grandas ol -22 dB; tiel estas sendanĝera agordi forton kiel 0.8 aŭ eĉ 1.8 dum ATK = 0 kaj grandega RLS, kiel 90 (funkcias nur en Firefox, RLS estas maksimume 1 en aliaj retumiloj)$N$N(rigardu vikipedion, ĝi klariĝas pli bone)",
