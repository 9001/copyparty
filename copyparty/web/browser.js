	...
	"fra": {
		...
		"hks": [
			[
				...
				"audio-player",
				["J/L", "piste précédente/suivante"],
				["U/O", "avancer/reculer de 10s"],
				["0..9", "sauter à 0%..90%"],
				["P", "lecture/pause (initie aussi)"],
				["S", "jouant sélection piste"],
				["Y", "téléchanger piste"],
			], [
				"image-viewer",
				["J/L, ←/→", "dernier/prochain image"],
				["Home/End", "premier/dernier image"],
				["F", "plein écran"],
				["R", "tourner dans le sens des aiguilles d'une montre"],
				["⇧ R", "tourner dans le sens contraire des aiguilles d'une montre"],
				["S", "sélection image"],
				["Y", "téléchanger image"],
			], [
				"video-player",
				["U/O", "avancer/reculer de 10s"],
				["P/K/Space", "jouer/pause"],
				["C", "continuer à jouer ensuite"],
				["V", "boucle"],
				["M", "muet"],
				["[ and ]", "mettre intervalle boucle"],
			], [
				"textfile-viewer",
				["I/K", "dernier/prochain fichier"],
				["M", "fermer fichier texte"],
				["E", "modifier fichier texte"],
				["S", "sélection fichier (pour coller/copier/renommer)"],
			]
		],
		...
		"ot_u2i": 'up2k: téléchargers fichiers (si vous avez un accès en écriture) ou passez en mode recherche pour voir s\'ils existent quelque part sur le serveur.$N$Nles téléchargements peuvent être repris, multithread, et les horodatages des fichiers sont conservés, mais il utilise plus de ressources CPU que [🎈]&nbsp; (le téléchargeur de base)<br /><br />pendant les téléchargements, cette icône devient un indicateur de progression!',
		"ot_u2w": 'up2k: téléchargers fichiers avec continuer assistance (ferme votre navigateur et déposez les mêmes fichiers plus tard)$N$Nmultithread, et les horodatages des fichiers sont conservés, mais il utilise plus de ressources CPU que [🎈]&nbsp; (le programme de téléchargement de base)<br /><br />pendant les téléchargements, cette icône devient un indicateur de progression!',
		...
		"wt_m3ua": "ajouter à la liste de lecture m3u (cliquez sur <code>📻copier</code> après)",
...
var LANGS = ["eng", "nor", "chi", "deu", "fin", "fra", "nld", "rus", "spa", "ukr"];
