...
var Ls = {
	...
	"nl": {
		...
		"ot_search": "zoek naar bestanden op basis van attributen, pad / naam, muziektags of een combinatie hiervan$N$N<code>foo bar</code> = bevat zowel «foo» als «bar»,$N<code>foo -bar</code> = bevat «foo» maar niet «bar»,$N<code>^yana .opus$</code> = begint met «yana» en is een «opus»-bestand$N<code>\"try unite\"</code> = bevat exact «try unite»$N$Nhet datumformaat is iso-8601, zoals$N<code>2009-12-31</code> of <code>2020-09-12 23:30:00</code>",
		...
		"ot_u2i": "up2k: upload bestanden (als je schrijfrechten hebt) of schakel naar zoekmodus om te zien of ze al op de server bestaan$N$Nuploads zijn hervatbaar, multithreaded en behouden bestandstijdstempels, maar gebruiken meer CPU dan [🎈] (de eenvoudige uploader)<br /><br />tijdens het uploaden wordt dit pictogram een voortgangsindicator!",
		"ot_u2w": "up2k: upload bestanden met hervat-ondersteuning (sluit je browser en voeg later dezelfde bestanden weer toe)$N$Nmultithreaded en bestandstijdstempels worden behouden, maar gebruikt meer CPU dan [🎈] (de eenvoudige uploader)<br /><br />tijdens het uploaden wordt dit pictogram een voortgangsindicator!",
		...
		"wt_cut": "knip geselecteerde items <small>(en plak elders)</small>$NToets: ctrl-X",
		...
		"wt_m3ua": "voeg toe aan m3u-afspeellijst (klik later op <code>📻kopieer</code>)",
		...
		"ul_btn": "sleep bestanden / mappen<br>hierheen (of klik op mij)",
		"ul_btnu": "U P L O A D",
		"ul_btns": "Z O E K",
		...
		"ut_etah": "gemiddelde <em>hash</em>-snelheid en geschatte resterende tijd",
		"ut_etau": "gemiddelde <em>upload</em>-snelheid en geschatte resterende tijd",
		"ut_etat": "gemiddelde <em>totale</em> snelheid en geschatte resterende tijd",
		...
		"ul_flagblk": "de bestanden zijn aan de wachtrij toegevoegd</b><br>maar er is een actieve up2k in een ander browsertabblad,<br>dus eerst wachten tot die klaar is",
		...
		"u_nav_m": "<h6>oké, wat heb je?</h6><code>Enter</code> = Bestanden (een of meer)\n<code>ESC</code> = Eén map (inclusief submappen)",
		"u_nav_b": "<a href=\"#\" id=\"modal-ok\">Bestanden</a><a href=\"#\" id=\"modal-ng\">Eén map</a>",
		...
		"cut_turbo": "de yolo-knop, je wilt dit waarschijnlijk NIET aanzetten:$N$Ngebruik dit als je een grote hoeveelheid bestanden aan het uploaden was en je moest herstarten, en je zo snel mogelijk wilt doorgaan$N$Nvervangt de hash-controle door een simpele <em>“heeft dit dezelfde bestandsgrootte?”</em> controle, dus bij andere inhoud wordt het NIET geüpload$N$Nzet dit uit wanneer de upload klaar is en 'upload' dezelfde bestanden opnieuw om te verifiëren",

		"cut_datechk": "heeft geen effect tenzij turbo is ingeschakeld$N$Nverlaagt de yolo-factor iets; controleert of de bestandstijdstempels overeenkomen$N$Nzou <em>theoretisch</em> onvolledige/corrupte uploads moeten detecteren, maar is geen vervanging voor een verificatie achteraf met turbo uit",
		...
		"fbd_more": "<div id=\"blazy\">toont <code>{0}</code> van <code>{1}</code> bestanden; <a href=\"#\" id=\"bd_more\">toon {2}</a> of <a href=\"#\" id=\"bd_all\">toon alles</a></div>",
		"fbd_all": "<div id=\"blazy\">toont <code>{0}</code> van <code>{1}</code> bestanden; <a href=\"#\" id=\"bd_all\">toon alles</a></div>",
		...
		"f_partial": "Om veilig een bestand te downloaden dat nog wordt geüpload, klik op het bestand met dezelfde naam maar zonder de extensie <code>.PARTIAL</code>. Klik op ANNULEREN of Escape om dit te doen.\n\nKlikken op OK / Enter negeert deze waarschuwing en downloadt het <code>.PARTIAL</code>-bestand, wat vrijwel zeker corrupte data oplevert.",
		...
		"fs_w8": "deel aanmaken...",
		"fs_ok": "druk op <code>Enter/OK</code> om te kopiëren\nof op <code>ESC/Annuleer</code> om te sluiten",
		...
		"fr_win": "Windows-veilige namen; vervang <code>&lt;&gt;:\"\\|?*</code> door Japanse tekens\">win",
		"fr_slash": "vervang <code>/</code> door een teken dat geen nieuwe mappen maakt\">geen /",
		...
		"fr_nchg": "{0} van de nieuwe namen zijn aangepast door <code>win</code> en/of <code>geen /</code>\n\nOK om door te gaan met deze aangepaste namen?",
		...
		"fd_warn2": "<b>Laatste kans!</b> Dit kan niet ongedaan worden. Verwijderen?",

		"fc_ok": "geknipt: {0} items",
		"fc_warn": "geknipt: {0} items\n\nmaar: alleen <b>dit</b> browser-tabblad kan ze plakken\n(aangezien de selectie enorm groot is)",
		...
		"fp_both_m": "<h6>kies wat je wilt plakken</h6><code>Enter</code> = Verplaats {0} bestanden van «{1}»\n<code>ESC</code> = Upload {2} bestanden vanaf je apparaat",
		"fcp_both_m": "<h6>kies wat je wilt plakken</h6><code>Enter</code> = Kopieer {0} bestanden van «{1}»\n<code>ESC</code> = Upload {2} bestanden vanaf je apparaat",
		"fp_both_b": "<a href=\"#\" id=\"modal-ok\">Verplaatsen</a><a href=\"#\" id=\"modal-ng\">Uploaden</a>",
		"fcp_both_b": "<a href=\"#\" id=\"modal-ok\">Kopiëren</a><a href=\"#\" id=\"modal-ng\">Uploaden</a>",
		...
		"gt_msel": "bestandsselectie inschakelen; ctrl-klik om te forceren$N$N<em>actief: dubbelklik opent bestand / map</em>$N$NSneltoets: S\">meerdere selecteren",
		...
		"un_nou": "<b>waarschuwing:</b> server te druk om onafgemaakte uploads te tonen; klik later op de \"ververs\"-link",
		"un_noc": "<b>waarschuwing:</b> unpost van voltooide bestanden is niet ingeschakeld/toegestaan in serverconfiguratie",
		"un_max": "alleen eerste 2000 bestanden worden getoond (gebruik de filter)",
		"un_avail": "{0} recente uploads kunnen worden verwijderd<br />{1} onafgemaakte kunnen worden afgebroken",
		"un_m2": "gesorteerd op uploadtijd; meest recent eerst:",
		"un_no1": "haha! geen uploads zijn recent genoeg",
		"un_no2": "haha! geen uploads met die filter zijn recent genoeg",
		"un_next": "verwijder de volgende {0} bestanden hieronder",
		"un_abrt": "afbreken",
		"un_del": "verwijderen",
		"un_m3": "laden van je recente uploads...",
		"un_busy": "bezig met verwijderen van {0} bestanden...",
		"un_clip": "{0} links gekopieerd naar klembord",

		"u_https1": "je zou",
		"u_https2": "moeten overschakelen naar https",
		"u_https3": "voor betere prestaties",
		"u_ancient": "je browser is indrukwekkend oud -- misschien kun je beter <a href=\"#\" onclick=\"goto('bup')\">bup gebruiken</a>",
		"u_nowork": "vereist firefox 53+ of chrome 57+ of iOS 11+",
		"tail_2old": "vereist firefox 105+ of chrome 71+ of iOS 14.5+",
		"u_nodrop": "je browser is te oud voor drag-and-drop uploaden",
		"u_notdir": "dat is geen map!\nje browser is te oud,\nprobeer dragdrop in plaats daarvan",
		"u_uri": "om afbeeldingen te slepen vanuit andere browservensters,\nsleep ze naar de grote uploadknop",
		"u_enpot": "overschakelen naar <a href=\"#\">aardappel-UI</a> (kan uploadsnelheid verbeteren)",
		"u_depot": "overschakelen naar <a href=\"#\">mooie UI</a> (kan uploadsnelheid verminderen)",
		"u_gotpot": "overschakelen naar aardappel-UI voor snellere upload,\n\nvoel je vrij om terug te schakelen!",
		"u_pott": "<p>bestanden: &nbsp; <b>{0}</b> voltooid, &nbsp; <b>{1}</b> mislukt, &nbsp; <b>{2}</b> bezig, &nbsp; <b>{3}</b> in wachtrij</p>",
		"u_ever": "dit is de basis-uploader; up2k vereist minimaal<br>chrome 21 // firefox 13 // edge 12 // opera 12 // safari 5.1",
		"u_su2k": "dit is de basis-uploader; <a href=\"#\" id=\"u2yea\">up2k</a> is beter",
		"u_uput": "optimaliseer voor snelheid (sla checksum over)",
		"u_ewrite": "je hebt geen schrijfrechten op deze map",
		"u_eread": "je hebt geen leesrechten op deze map",
		"u_enoi": "bestandszoekfunctie is niet ingeschakeld in serverconfig",
		"u_enoow": "overschrijven werkt hier niet; verwijderrechten nodig",
		"u_badf": "Deze {0} bestanden (van {1} totaal) zijn overgeslagen, mogelijk door bestandsrechten:\n\n",
		"u_blankf": "Deze {0} bestanden (van {1} totaal) zijn leeg; toch uploaden?\n\n",
		"u_applef": "Deze {0} bestanden (van {1} totaal) zijn waarschijnlijk ongewenst;\nDruk op <code>OK/Enter</code> om deze bestanden OVER TE SLAAN,\nDruk op <code>Annuleer/ESC</code> om ze WEL te uploaden:\n\n",
		"u_just1": "\nMisschien werkt het beter als je maar één bestand selecteert",
		"u_ff_many": "als je <b>Linux / MacOS / Android</b> gebruikt, kan deze hoeveelheid bestanden <a href=\"https://bugzilla.mozilla.org/show_bug.cgi?id=1790500\" target=\"_blank\"><em>Firefox doen crashen!</em></a>\nals dat gebeurt, probeer opnieuw (of gebruik Chrome).",
		"u_up_life": "Deze upload wordt verwijderd van de server\n{0} na voltooiing",
		"u_asku": "deze {0} bestanden uploaden naar <code>{1}</code>",
		...
		"u_emtleak2": ' <a href="{0}">over te schakelen naar https (aanbevolen)</a> of ',
		"u_emtleak3": ' ',
		"u_emtleakc": 'probeer het volgende:\n<ul><li>druk op <code>F5</code> om de pagina te vernieuwen</li><li>schakel dan de knop &nbsp;<code>mt</code>&nbsp; uit bij &nbsp;<code>⚙️ instellingen</code></li><li>probeer de upload opnieuw</li></ul>Uploads zullen wat trager zijn, maar oké.\nSorry voor het ongemak!\n\nPS: chrome v107 <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=1354816" target="_blank">heeft hier een bugfix voor</a>',
		"u_emtleakf": 'probeer het volgende:\n<ul><li>druk op <code>F5</code> om de pagina te vernieuwen</li><li>schakel daarna <code>🥔</code> (aardappelmodus) in de upload-UI in<li>probeer de upload opnieuw</li></ul>\nPS: firefox <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=1790500" target="_blank">heeft hopelijk binnenkort een bugfix</a>',
		"u_s404": "niet gevonden op server",
		"u_expl": "uitleg",
		"u_maxconn": "de meeste browsers beperken dit tot 6, maar firefox laat je dit verhogen met <code>connections-per-server</code> in <code>about:config</code>",
		"u_tu": "<p class=\"warn\">WAARSCHUWING: turbo ingeschakeld, <span>&nbsp;client detecteert mogelijk geen onvoltooide uploads; zie tooltip bij turbo-knop</span></p>",
		"u_ts": "<p class=\"warn\">WAARSCHUWING: turbo ingeschakeld, <span>&nbsp;zoekresultaten kunnen onjuist zijn; zie tooltip bij turbo-knop</span></p>",
		"u_turbo_c": "turbo is uitgeschakeld in serverconfiguratie",
		"u_turbo_g": "turbo uitgeschakeld omdat je geen mapinhoud mag bekijken binnen dit volume",
		"u_life_cfg": "automatisch verwijderen na <input id=\"lifem\" p=\"60\" /> min (of <input id=\"lifeh\" p=\"3600\" /> uur)",
		"u_life_est": "upload wordt verwijderd op <span id=\"lifew\" tt=\"lokale tijd\">---</span>",
		"u_life_max": "deze map heeft een\nmaximale bewaartijd van {0}",
		"u_unp_ok": "verwijderen is toegestaan voor {0}",
		"u_unp_ng": "verwijderen is NIET toegestaan",
		"ue_ro": "je hebt alleen-lezen toegang tot deze map\n\n",
		"ue_nl": "je bent momenteel niet ingelogd",
		"ue_la": "je bent momenteel ingelogd als \"{0}\"",
		"ue_sr": "je bent momenteel in bestandszoekmodus\n\nschakel naar uploadmodus door op het vergrootglas 🔎 te klikken (naast de grote ZOEK-knop), en probeer opnieuw te uploaden\n\nsorry",
		"ue_ta": "probeer opnieuw te uploaden, het zou nu moeten werken",
		"ue_ab": "dit bestand wordt al geüpload in een andere map, en die upload moet eerst worden voltooid.\n\nJe kunt die upload afbreken via de 🧯 linksboven",
		...
		"ur_1un": "Upload mislukt, sorry",
		"ur_aun": "Alle {0} uploads zijn mislukt, sorry",
		"ur_1sn": "Bestand is NIET gevonden op server",
		"ur_asn": "De {0} bestanden zijn NIET gevonden op server",
		"ur_um": "Voltooid;\n{0} uploads OK,\n{1} uploads mislukt, sorry",
		"ur_sm": "Voltooid;\n{0} bestanden gevonden op server,\n{1} bestanden NIET gevonden op server",

		"lang_set": "verversen om de wijziging door te voeren?",
	},
	"rus": {
		"tt": "Русский",
...
var LANGS = ["eng", "nor", "chi", "deu", "rus", "ukr", "ita"];
