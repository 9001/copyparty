...
"		im_hnf": "tuota kuvaa ei enää ole olemassa",
	...
	"fra": {
		...
		"hks": [
			[
				"misc",
				["ESC", "ferme divers menu"],

				"gestionaire de fichier",
				["G", "activer vue en liste / vue en grille"],
				["T", "activer les miniatures / icons"],
				["⇧ A/D", "taille des miniatures"],
				["ctrl-K", "suprimer la selection"],
				["ctrl-X", "couper la selection au presse-papier"],
				["ctrl-C", "copier la selection au presse-papier"],
				["ctrl-V", "coller (deplacer/copier) ici"],
				["Y", "télécharger la selection"],
				["F2", "renomer la selection"],

				"file-list-sel",
				["space", "activer la selection de fichiers"],
				["↑/↓", "deplacer le selecteur"],
				["ctrl ↑/↓", "move cursor and viewport"],
				["⇧ ↑/↓", "selectioner fichier precedent/suivant"],
				["ctrl-A", "selectioner tout les fichiers / dossiers"],
			], [
				"navigation",
				["B", "toggle breadcrumbs / navpane"],
				["I/K", "dossier precedent/suivant"],
				...
				["Y", "telecharger l'image"],
			], [
				"lecteur vidéo",
				["U/O", "sauter 10sec en arrière/avant"],
				["P/K/Space", "lecture/pause"],
				...
				["S", "selectioner le fichier (pour le couper/copier/renommer)"],
			]
		],
		...
		"enable": "Activer",
		"danger": "DANGER",
		"clipped": "copié au presse-papier",
		...
		"ut_rand": "randomisation des noms de fichiers",
		...
		"ut_mt": "continuer à calculer le hash d'autres fichiers pendant le téléversement$N$Npeut-être désactiver si votre CPU ou HDD est la cause de perte de performances",
		...
		"ul_flagblk": "les fichiers ont été ajouté a la file d'atente</b><br>mais cepandant il y a un processus up2k ocupé dans un autre onglets de navigateur,<br>en attente qu'il finisse en premier",
		"ul_btnlk": "la configuration du serveur a verouillé cette options dans cet état",
		...
		"cl_themes": "thèmes",
		"cl_langs": "language",
		"cl_ziptype": "telechargement de dossier",
		"cl_uopts": "up2k",
		"cl_favico": "favicon",
		"cl_bigdir": "big dirs",
		"cl_hsort": "#sort",
		...
		"ct_grid": '田 la grille',
		"ct_ttips": '◔ ◡ ◔">ℹ️ infobules',
		"ct_thumb": 'vue en grille, activer les icons ou les miniatures$NHotkey: T">🖼️ minia',
		"ct_csel": 'utiliser CTRL et SHIFT pour selectioner des fichiers en vue en grille">sel',
		"ct_ihop": 'quand le visualisateur d\'image est fermé, faire defiller vers le bas jusqu\'au dernier fichier down to the last viewed file">g⮯',
		...
		"cut_umod": "si un fichier existe deja sur le server, mettre à jour l'horodatage de dernière modification du serveur pour qu'il corresponde à votre fichier local (nécessite des autorisations d'écriture et de suppression)\">re📅",
		...
		"cut_u2sz": "taille (en MiB) de chaque morceau de televersement; des grosse valeurs vont mieux passer si la distance entre le serveur et vous est trés grande. Si vous avez une connection trés instable, essayer de plus petites valeurs",

		"cut_flag": "enforcer le fait qu'un seul onglet est entrain de mettre un fichier en ligne a la fois $N -- les autres onglets doivent avoir cette option activé aussi $N -- affecte seulement les onglets qui sont sur le même domaine",

		"cut_az": "metre en ligne les fichiers dans l'ordre alphabetique, plutot que le plus petit fichier en premier$N$Nl'ordre alphabetique peut rendre la lecture plus douce sur les yeux si quel-que chose s'est mal passé sur le serveur, mais cela rend le televersement légèrement plus lent sur fibre / LAN",

		"cut_nag": "recevoir une notification via l'OS quand un televersement finit$N(seulement si le navigateur ou l'onglet n'est pas actif)",
		"cut_sfx": "alerte audible quand le televersement finit$N(seulement si le navigateur ou l'onglet n'est pas actif)",

		"cut_mt": "utiliser le hashing en multithreading pour accelerer le processus$N$Ncela utilise des web-workers et nécessite$Nplus de RAM (jusqu'à 512 MiB supplémentaires)$N$NCella rend https 30% plus rapide, http 4.5x plus rapide\">mt",
		...
		"cft_text": "text favicon (laiser vide et rafraichir pour desactiver)",
		"cft_fg": "color de premier-plan",
		...
		"cdt_hsort": "combien de règles de tri (&lt;code&gt;,sorthref&lt;/code&gt;) à inclure dans les medial-URLs. Définir cette valeur à 0 ignorera également les règles de tri incluses dans les liens média lorsque vous cliquez dessus.",
		...
		"mt_loop": "repeter en boucle une musique\">🔁",
		"mt_one": "stoper apres une musique\">1️⃣",
		...
		"mt_prescan": "explorer le dossier suivant avant la dernière musique$Nne finise, pour garder le navigateur content$Npour qu'il n'arete pas la lecture\">nav",
		"mt_fullpre": "essayer de pre-charcher la musique entiere;$N✅ activer en cas de conection <b>instable</b>,$N❌ <b>desactiver</b> en revanche sur une connection lente va probablement être mieux\">full",
		"mt_fau": "sur telephone, empeche la musique de s'aretter de jouer si la prochaine n'est pas prechargée assez rapidement (peut rendre l'affichage des tags buggé)\">☕️",
		"mt_waves": "barre de progression en spectrograme:$Nmontrer l'amplitude audio dans la miniature\">~s",
		"mt_npclip": "montrer les boutons pour copier la chanson en cours de lecture\">/np",
		"mt_m3u_c": "montrer les boutons pour copier les$Nchansons sélectionnées en tant qu'entrées de playlist m3u8\">📻",
		...
		"mt_mloop": "boucler le dossier ouvert\">🔁 loop",
		...
		"mm_opusen": "votre navigateur ne peut pas lire les fichiers aac / m4a ;\nla transcodage en opus est maintenant activé",
		"mm_playerr": "échec de la lecture : ",
		"mm_eabrt": "The playback attempt was cancelled",
		"mm_enet": "Ta connexion internet est instable ou inexistante",
		"mm_edec": "Ce fichier est suposement corrompu??",
		...
		"mm_nof": "j'ai pas pu trouver d'autres fichiers audio à lire",
		"mm_prescan": "En recherche d'une autre musique à lire...",
		"mm_scank": "J'ai trouvé la prochaine musique :",
		...
		"f_bigtxt": "ce fichier fait {0} MiB -- tu veut vraiment le voir en tant que text?",
		"f_bigtxt2": "view just the end of the file instead? this will also enable following/tailing, showing newly added lines of text in real time",
		"fbd_more": '<div id="blazy">showing <code>{0}</code> of <code>{1}</code> files; <a href="#" id="bd_more">show {2}</a> or <a href="#" id="bd_all">show all</a></div>',
		"fbd_all": '<div id="blazy">showing <code>{0}</code> of <code>{1}</code> files; <a href="#" id="bd_all">show all</a></div>',
		...
		"fp_ename": "{0} éléments ne peuvent pas être deplacé ici parceque leurs nom sont deja pris. Donnez leurs un nouveau nom ci-dessous pour continuer, ou laissez les vide pour les sauter:",
		"fcp_ename": "{0} éléments ne peuvent pas être copiés ici parce que les noms sont déjà pris. Donnez leurs un nouveau nom ci-dessous pour continuer, ou laissez les vide pour les sauter:",
		...
		"tvt_close": "retour a la vue de dossier$NHotkey: M (or Esc)\">❌ fermer",
		"tvt_dl": "télécharger ce fichier$NHotkey: Y\">💾 télécharger",
		"tvt_prev": "montrer le document précédent$NHotkey: i\">⬆ prev",
		"tvt_next": "montrer le document suivant$NHotkey: K\">⬇ next",
		"tvt_sel": "sélectionner le fichier &nbsp; ( pour couper / copier / supprimer / ... )$NHotkey: S\">sel",
		"tvt_edit": "ouvrir le fichier dans l'éditeur de texte$NHotkey: E\">✏️ edit",
		"tvt_tail": "surveiller le fichier pour les changements; montrer les nouvelles lignes en temps réel\">📡 follow",
		"tvt_wrap": "retour a la ligne\">↵",
		"tvt_atail": "ancrer le défilement au fond de la page\">⚓",
		"tvt_ctail": "decoder les couleurs du terminal (ansi escape codes)\">🌈",
		"tvt_ntail": "limite de défilement en ariere (combien de bytes de text a garder chargé)",

		"m3u_add1": "musique ajouté à la playlist m3u",
		"m3u_addn": "{0} musiques ajoutés à la playlist m3u",
		"m3u_clip": "la playlist m3u est maintenant copié dans le presse-papier\n\nvous devriez creer un nouveau fichier text nommé par example playlist.m3u et coller la playlist dans ce fichier; cela la rendra lisible en tant que playlist",

		"gt_vau": "ne pas voir les videos, juste jouer l'audio audio\">🎧",
		"gt_msel": "activer la selection de fichiers; ctrl-click sur un fichier pour override$N$N&lt;em&gt;quand actif: doubleclick un fichier / dossier pour l'ouvrir&lt;/em&gt;$N$NHotkey: S\">multiselection",
		"gt_crop": "center-crop miniatures\">crop",
		"gt_3x": "miniatures haute resolution\">3x",
		"gt_zoom": "zoom",
		"gt_chop": "chop",
		"gt_sort": "trier par",
		"gt_name": "nom",
		...
		"xhr0": "inconnu (probablement perdu la connexion au serveur, ou le serveur est hors ligne)",
		...
		"fz_zipc": "cp437 avec crc32 calculé tôt,$Nfor MS-DOS PKZIP v2.04g (october 1993)$N(takes longer to process before download can start)",
		...
		"u_ancient": 'votre navigateur est impresionament ancien -- vous devrez peut-être <a href="#" onclick="goto(\'bup\')">utiliser bup à la place</a>',
		"u_nowork": "necessite firefox 53+ ou chrome 57+ ou iOS 11+",
		"tail_2old": "necessite firefox 105+ ou chrome 71+ ou iOS 14.5+",
		...
		"u_unpt": "vous pouvez defaire / supprimer ce téléversement en utilisant le 🧯 en haut à gauche",
		...
		"u_ehssrch": "le serveur a rejeté la demande d'effectuer une recherche ; réessaie...",
		...
		"lang_set": "rafraichir pour que les changements prennent effet ?",
	},
};

var LANGS = ["eng", "nor", "chi", "deu", "fin", "ita", "nld", "rus", "spa", "ukr", "fra"];
