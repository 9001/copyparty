	...
	"jp": {
		...
		"hks": [
			[
				...
				["ctrl ↑/↓", "カーソルと可視領域を動かす"],
				["⇧ ↑/↓", "前後のファイルを選択"],
				["ctrl-A", "すべてのファイル・フォルダーを選択"],
			], [
				"navigation",
				["B", "パンくずリスト・ナビパネルを切り替え"],
				["I/K", "前後のフォルダー"],
				["M", "親フォルダーを見る"],
				["V", "ナビパネルのフォルダー・テキストファイル表示を切り替え"],
				["A/D", "ナビパネルの大きさを変える"],
			], [
				"audio-player",
				["J/L", "前後の曲"],
		...
		"access": " アクセス",
		"ot_close": "サブメニューを閉じる",          
		"ot_search": "属性・パス・名前・音楽タグなど、またはその組み合わせでファイルを検索$N$N&lt;code&gt;foo bar&lt;/code&gt; = «foo»と«bar»との両方を含む,$N&lt;code&gt;foo -bar&lt;/code&gt; = «bar»を含まず«foo»を含む,$N&lt;code&gt;^yana .opus$&lt;/code&gt; = «yana»で始まりかつ«opus»ファイルである$N&lt;code&gt;&quot;try unite&quot;&lt;/code&gt; = «try unite»という文字列を含む$N$N日付フォーマットがiso-8601(例$N&lt;code&gt;2009-12-31&lt;/code&gt; または &lt;code&gt;2020-09-12 23:30:00&lt;/code&gt;）",
		"ot_unpost": "アップロード取消: 最近のアップロードを取り消し, 若しくは未完了アップロードを中断",
		"ot_bup": "bup: 基本的なアップロード, netscape 4.0も利用可",
		"ot_mkdir": "mkdir: 新フォリダーを作成",
		"ot_md": "new-md: 新Markdownファイルを作成",
		"ot_msg": "msg: サーバーログにメッセージを送信",
		"ot_mp": "メディアプレイヤー設定",
		"ot_cfg": "設定項目",
		"ot_u2i": 'up2k: upload files (if you have write-access) or toggle into the search-mode to see if they exist somewhere on the server$N$Nuploads are resumable, multithreaded, and file timestamps are preserved, but it uses more CPU than [🎈]&nbsp; (the basic uploader)<br /><br />during uploads, this icon becomes a progress indicator!',
		"ot_u2w": 'up2k: upload files with resume support (close your browser and drop the same files in later)$N$Nmultithreaded, and file timestamps are preserved, but it uses more CPU than [🎈]&nbsp; (the basic uploader)<br /><br />during uploads, this icon becomes a progress indicator!',
		"ot_noie": 'Chrome / Firefox / Edgeをご利用ください',

		"ab_mkdir": "新フォリダーを作成",
		"ab_mkdoc": "新Markdownファイルを作成",
		"ab_msg": "サーバーログにメッセージを送信",
...
var LANGS = ["eng", "nor", "chi", "cze", "deu", "fin", "fra", "grc", "ita", "kor", "nld", "nno", "pol", "por", "rus", "spa", "swe", "ukr", "jp"];
