...
def add_thumbnail(ap):
    ...
    ap2.add_argument("--th-extr-cv", metavar="T,T", type=u, default="", help="list of extractable formats to use as folder covers with \033[33m-e2t\033[0m; prefix with '!' to use all formats except listed; set to '*' to allow all formats; example: [\033[32mpdf,djvu,fb2\033[0m], [\033[32!md,txt,docx,xlsx\033[0m], [\033[32*\033[0m]")
