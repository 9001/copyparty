...
def add_ui(ap, retry: int):
    ...
    ap2.add_argument("--bg-img", metavar="M,M,M", type=u, default="", help="URL to .jpg/png/gif/svg file, for example \033[32mhttps://server.com/bg.jpg,opacity=0.5(optional),blur=5(optional)\033[0m (volflag=bg-img)")
